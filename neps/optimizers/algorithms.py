    ...
    *,
    ...
    if isinstance(pipeline_space, PipelineSpace):
        ...
        if converted_space is not None:
            ...
            return neps_grid_search(pipeline_space, ignore_fidelity=ignore_fidelity, size_per_numerical_dimension=size_per_numerical_dimension)
    ...
    return GridSearch(
        configs_list=make_grid(pipeline_space, ignore_fidelity=ignore_fidelity, size_per_numerical_hp=size_per_numerical_dimension)
    )
