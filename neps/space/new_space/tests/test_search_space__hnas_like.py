...
def test_hnas_like_context():
    samplings_to_make = {
        ...
        "Resolvable.CL.args[0].resampled_categorical.sampled_value.resampled_operation.args[0].resampled_operation.args[0]::categorical__4": 0,
        "Resolvable.CL.args[0].resampled_categorical.sampled_value.resampled_operation.args[0].resampled_operation.args[1]::categorical__3": 2,
        "Resolvable.CL.args[0].resampled_categorical.sampled_value.resampled_operation.args[0].resampled_operation.args[2].resampled_categorical::categorical__3": 0,
        ...
        "Resolvable.CL.args[4].resampled_categorical.sampled_value.resampled_operation.args[0].resampled_operation.args[2].resampled_categorical::categorical__3": 2,
        ...
        "Resolvable.ARCH.sampled_value.args[0].resampled_categorical.sampled_value.args[0].resampled_categorical::categorical__3": 2,
        "Resolvable.ARCH.sampled_value.args[0].resampled_categorical.sampled_value.args[1].resampled_categorical::categorical__3": 0,
        "Resolvable.ARCH.sampled_value.args[1].resampled_categorical::categorical__3": 2,
        "Resolvable.ARCH.sampled_value.args[1].resampled_categorical.sampled_value.args[0].resampled_categorical::categorical__3": 0,
        "Resolvable.ARCH.sampled_value.args[1].resampled_categorical.sampled_value.args[1].resampled_categorical::categorical__3": 0,
        "Resolvable.ARCH.sampled_value.args[1].resampled_categorical.sampled_value.args[2].resampled_categorical::categorical__3": 0,
        "Resolvable.ARCH.sampled_value.args[1].resampled_categorical.sampled_value.args[3].resampled_categorical::categorical__3": 1,
    ...
    #
    # print("Arch expected:")
    # pretty_config = config_string.ConfigString(expected_arch_config_string).pretty_format()
    # print(pretty_config)
