"""
Official implementation of TrivialAugment from the AutoML Repo:
...
class TransformT:
    ...
    def pil_transformer(self, probability, level):
        ...
        name = self.name + f"({probability:.1f},{level})"
...
def blend(img1, v):
    ...
    img2 = blend_images[i]  # pylint: disable=E1136
...
def set_augmentation_space(
    ...
    global ALL_TRANSFORMS, min_max_vals, PARAMETER_MAX  # pylint: disable=W0601
