...
def plot_correlations(
    ...
    matrix_plot(
        corr_matrix_model,
        plot_log_dir=os.path.join(
            model_log_dir, "fidelity_correlation_model_" + str(model_type) + ".pdf"
        ),
    )
    matrix_plot(
        corr_matrix_random,
        plot_log_dir=os.path.join(
            model_log_dir, "fidelity_correlation_random_" + str(model_type) + ".pdf"
        ),
    )
...
def fidelity_correlation_interface(
    model_log_dir, nasbench_data, configspace_path, apply_noise
):
    return fidelity_correlation(
        model_log_dir, nasbench_data, configspace_path, apply_noise
    )
