...
| `cost`                  | wall‑clock, GPU‑hours, … — only if you passed `worker_cost_to_spend` to `neps.run` | yes *iff* cost budget enabled |
