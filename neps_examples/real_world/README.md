...
This example demonstrates HPO for an [OpenCLIP](https://github.com/mlfoundations/open_clip) model, searching over optimization hyperparameters (learning rate, weight decay) as well as the vision/text tower width and depth.
...
python vlm_openclip/pipeline/download_data.py
...
```bash
python vlm_openclip/pipeline/post_hoc_downstream_eval.py --root_dir results/hpo_vlm_openclip
```
