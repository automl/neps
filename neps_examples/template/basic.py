...
def evaluate_pipeline(lr: float) -> dict | float:
    # Evaluate pipeline should include the following steps:

    # 1. Defining the model.
    # 1.1 Load any checkpoint if necessary
    # 2. Each optimization variable should get its values from the pipeline space, i.e. "lr".
    # 3. The training loop
    ...
    logger.info(f"Running pipeline with learning_rate {lr}")
