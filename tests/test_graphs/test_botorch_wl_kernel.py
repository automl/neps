...
class TestBoTorchWLKernel:
    @pytest.fixture
    def simple_graphs(self) -> list[nx.Graph]:
        return create_simple_graphs(3)

    @pytest.fixture
    def wl_kernel(self, simple_graphs: list[nx.Graph]) -> BoTorchWLKernel:
    ...
    def test_initialization(
        self, wl_kernel: BoTorchWLKernel, simple_graphs: list[nx.Graph]
    ) -> None:
    ...
    def test_precompute_graph_data(self, wl_kernel: BoTorchWLKernel) -> None:
    ...
    def test_set_graph_lookup(self, wl_kernel: BoTorchWLKernel) -> None:
    ...
    def test_forward_self_kernel(self, wl_kernel: BoTorchWLKernel) -> None:
    ...
    def test_forward_cross_kernel(self, wl_kernel: BoTorchWLKernel) -> None:
    ...
    def test_forward_diagonal(self, wl_kernel: BoTorchWLKernel) -> None:
    ...
    def test_handle_negative_one_index(self, wl_kernel: BoTorchWLKernel) -> None:
    ...
    def test_forward_batched_input(self, wl_kernel: BoTorchWLKernel) -> None:
    ...
    def test_forward_invalid_input(self, wl_kernel: BoTorchWLKernel) -> None:
