...
from neps.optimizers.models.graphs.kernels import TorchWLKernel
...
class TestTorchWLKernel:
    ...
    @pytest.fixture
    def example_graphs_set(self) -> list[nx.Graph]:
    ...
    @pytest.fixture
    def random_graphs_sets(self) -> list[list[nx.Graph]]:
    ...
    def test_wl_kernel_against_grakel(
        self, n_iter: int, normalize: bool, random_graphs_sets: list[list[nx.Graph]]
    ) -> None:
    ...
    def test_wl_kernel_with_empty_graph_and_reordered_edges(
        self, random_graphs_sets: list[list[nx.Graph]]
    ) -> None:
    ...
    @pytest.mark.parametrize("normalize", [True, False])
    def test_wl_kernel_with_different_node_labels(
        self, n_iter: int, normalize: bool, example_graphs_set: list[nx.Graph]
    ) -> None:
        graphs = []
    ...
    def test_wl_kernel_with_same_node_labels(
        self, example_graphs_set: list[nx.Graph]
    ) -> None:
