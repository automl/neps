...
class DyHPOBase(BaseOptimizer):
    ...
    def __init__(
        ...
        model_policy_args: Union[dict[str, Any]] = None,
        sample_policy_args: Union[dict[str, Any]] = None,
        promotion_policy_args: Union[dict[str, Any]] = None,
        promotion_type: str = "model",
        sample_type: str = "model",
        sampling_args: Union[dict[str, Any], None] = None,
