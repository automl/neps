...
class EvolutionSampler(AcquisitionSampler):
    ...
    def evolution(
        ...
        def inner_loop(population, fitness, X_max, acq_max):
            ...
            fitness = acquisition_function(X_max + population, grad=False).numpy()
        ...
        fitness = acquisition_function(population, grad=False).numpy()
    ...
    def sample(self, acquisition_function, constraint=None) -> SearchSpace:
        ...
        if (
            ...
            acq_vals = acquisition_function(self.x, grad=False).numpy()
